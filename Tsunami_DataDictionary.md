# Data Dictionary (Grouped by Domain)
...
| Occupancy_Type | Hazus occupancy classification (e.g., RES1, COM1, IND2)                           |
...
| depth_in_structure_10y           | Flow depth in structure in feet (median flow depth – foundation height) for the 10-year return period                |
| depth_in_structure_25y           | Flow depth in structure in feet (median flow depth – foundation height) for the 25-year return period                |
| depth_in_structure_50y           | Flow depth in structure in feet (median flow depth – foundation height) for the 50-year return period                |
| depth_in_structure_72y           | Flow depth in structure in feet (median flow depth – foundation height) for the 72-year return period                |
| depth_in_structure_100y          | Flow depth in structure in feet (median flow depth – foundation height) for the 100-year return period               |
| depth_in_structure_150y          | Flow depth in structure in feet (median flow depth – foundation height) for the 150-year return period               |
| depth_in_structure_200y          | Flow depth in structure in feet (median flow depth – foundation height) for the 200-year return period               |
| depth_in_structure_250y          | Flow depth in structure in feet (median flow depth – foundation height) for the 250-year return period               |
| depth_in_structure_475y          | Flow depth in structure in feet (median flow depth – foundation height) for the 475-year return period               |
| depth_in_structure_750y          | Flow depth in structure in feet (median flow depth – foundation height) for the 750-year return period               |
| depth_in_structure_975y          | Flow depth in structure in feet (median flow depth – foundation height) for the 975-year return period               |
| depth_in_structure_1500y         | Flow depth in structure in feet (median flow depth – foundation height) for the 1500-year return period              |
| depth_in_structure_2475y         | Flow depth in structure in feet (median flow depth – foundation height) for the 2475-year return period              |
| depth_in_structure_3000y         | Flow depth in structure in feet (median flow depth – foundation height) for the 3000-year return period              |
...
| FIELD               | DESCRIPTION                                                                                |
|:--------------------|:-------------------------------------------------------------------------------------------|
| Occupancy           | Hazus occupancy classification (e.g., RES1, COM1, IND2)                                    |
...
| Occupancy_econInc   | Hazus occupancy classifications with inventory related losses (e.g., AGR1, COM1-2, IND1-6) |
| GrossSales          | Annual gross sales ($ per sqft)                                                            |
...
| CapitalLoss_AAL           | Capital Related (e.g., building+content+inventory) Average Annual Loss ($)                |
| IncomeLoss_AAL            | Income Related (e.g., relocation+proprietor income+rental+wage) Average Annual Loss ($)   |
| TotalEconomicLoss_AAL     | Total Economic (e.g., Capital+Income) Average Annual Loss ($)                             |

## LOSSES (ACTUARIAL LOSS)

| FIELD                          | DESCRIPTION                                                                                                                           |
|:-------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------|
| gross_building_loss_10yr       | Gross building (e.g. deductibles and limits applied) loss ($) for the 10-year return period                                           |
| gross_building_loss_25yr       | Gross building (e.g. deductibles and limits applied) loss ($) for the 25-year return period                                           |
| gross_building_loss_50yr       | Gross building (e.g. deductibles and limits applied) loss ($) for the 50-year return period                                           |
| gross_building_loss_72yr       | Gross building (e.g. deductibles and limits applied) loss ($) for the 72-year return period                                           |
| gross_building_loss_100yr      | Gross building (e.g. deductibles and limits applied) loss ($) for the 100-year return period                                          |
| gross_building_loss_150yr      | Gross building (e.g. deductibles and limits applied) loss ($) for the 150-year return period                                          |
| gross_building_loss_200yr      | Gross building (e.g. deductibles and limits applied) loss ($) for the 200-year return period                                          |
| gross_building_loss_250yr      | Gross building (e.g. deductibles and limits applied) loss ($) for the 250-year return period                                          |
| gross_building_loss_475yr      | Gross building (e.g. deductibles and limits applied) loss ($) for the 475-year return period                                          |
| gross_building_loss_750yr      | Gross building (e.g. deductibles and limits applied) loss ($) for the 750-year return period                                          |
| gross_building_loss_975yr      | Gross building (e.g. deductibles and limits applied) loss ($) for the 975-year return period                                          |
| gross_building_loss_1500yr     | Gross building (e.g. deductibles and limits applied) loss ($) for the 1500-year return period                                         |
| gross_building_loss_2475yr     | Gross building (e.g. deductibles and limits applied) loss ($) for the 2475-year return period                                         |
| gross_building_loss_3000yr     | Gross building (e.g. deductibles and limits applied) loss ($) for the 3000-year return period                                         |
| gross_building_loss_aal        | Gross building (e.g. deductibles and limits applied) Average Annual Loss ($)                                                          |
| GrossBldgAAL_LossRatio_USDperM | Gross building (e.g. deductibles and limits applied) Average Annual Loss Ratio ($ per $1 million building structure replacement cost) |
| gross_content_loss_aal         | Gross content (e.g. deductibles and limits applied) Average Annual Loss ($)                                                           |
